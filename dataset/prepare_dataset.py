...
from merge_label_features import main as merge_and_label_dataset
time_frame_increment = 5
context_window_size=4
run_subtitle_process=False
run_average_calculator=False
...
if __name__ == "__main__":
    ...
    if (run_labelling_process): 
        ...
        merge_and_label_dataset(context_window_size)