...
##This function creates average intensity values for selected time frames and fill the missing time frame
##average values with interpolation method
        ...
        if os.path.isdir(subfolder_path):
            for file in os.listdir(subfolder_path):
                if file.endswith("_heatmap.csv"):
                    ...
                    # Merge with full bins and interpolate missing values
