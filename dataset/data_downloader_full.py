...
video_urls = [
    "https://www.youtube.com/watch?v=7csEy0k0pDc&ab_channel=SafiyaNygaard"
]
...
def process_video(url):
    ...
    try:
        ...
        # Step 4: Download video only
        video_opts = {
            'outtmpl': output_template.replace("%(suffix)s", "video"),
            'format': 'bv[ext=mp4]+ba/bestvideo[ext=mp4]',
        ...
        # Step 5: Download audio and convert to MP3
        audio_opts = {
            'outtmpl': output_template.replace("%(suffix)s", "audio"),
